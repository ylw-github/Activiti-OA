...
!function (a, b, c) {
    ...
    function n() {
        ...
        if (this.element._bgBusyAria(!0).trigger("load" + H), F.call(this), this.options.ajax) {
            var f = g.call(this), h = i.call(this);
            ...
            var j = {
                url: h, data: f, success: function (b) {
    ...
    function o() {
        if (!this.options.ajax) {
            var b = this, c = this.element.find("tbody > tr");
            c.each(function () {
                var c = a(this), e = c.children("td"), f = {};
    ...
    function r() {
        if (0 !== this.options.navigation) {
            var b = this.options.css, c = h(b.actions), d = e.call(this, c);
            if (d.length > 0) {
                var g = this, i = this.options.templates, j = a(i.actions.resolve(f.call(this)));
                if (this.options.ajax) {
                    var k = i.icon.resolve(f.call(this, {iconCss: b.iconRefresh})),
    ...
    function s(b) {
        if (this.options.columnSelection && this.columns.length > 1) {
            var c = this, d = this.options.css, e = this.options.templates,
                g = e.icon.resolve(f.call(this, {iconCss: d.iconColumns})),
                i = a(e.actionDropDown.resolve(f.call(this, {content: g}))), j = h(d.dropDownItem),
                k = h(d.dropDownItemCheckbox), m = h(d.dropDownMenuItems);
    ...
    function t() {
        if (0 !== this.options.navigation) {
            var b = h(this.options.css.infos), c = e.call(this, b);
            if (c.length > 0) {
    ...
    function u() {
        var a = this.element.children("tbody").first(), b = this.options.templates,
            c = this.columns.where(l).length;
        this.selection && (c += 1), a.html(b.noResults.resolve(f.call(this, {columns: c})))
    }
    ...
    function v() {
        if (0 !== this.options.navigation) {
            ...
            if (-1 !== this.rowCount && c.length > 0) {
                var d = this.options.templates, g = this.current, i = this.totalPages,
                    j = a(d.pagination.resolve(f.call(this))), k = i - g,
                    l = -1 * (this.options.padding - g),
                    m = k >= this.options.padding ? Math.max(l, 1) : Math.max(l - this.options.padding + k, 1),
                    n = 2 * this.options.padding + 1, o = i >= n ? n : i;
    ...
    function w(b, c, d, e) {
        var g = this, i = this.options.templates, j = this.options.css,
            k = f.call(this, {css: e, text: d, page: c}),
    ...
    function x(b) {
        ...
        var d = this, e = this.options.rowCount;
        if (a.isArray(e)) {
            var g = this.options.css, i = this.options.templates,
                j = a(i.actionDropDown.resolve(f.call(this, {content: c(this.rowCount)}))),
                k = h(g.dropDownMenu), l = h(g.dropDownMenuText), m = h(g.dropDownMenuItems),
    ...
    function y(b) {
        if (b.length > 0) {
            var c = this, d = this.options.css, e = this.options.templates,
                g = this.element.children("tbody").first(), i = !0, j = "";
    ...
    function z(b) {
        var c = this, d = h(this.options.css.selectBox);
    ...
    function A() {
        if (0 !== this.options.navigation) {
            var c = this.options.css, d = h(c.search), g = e.call(this, d);
            if (g.length > 0) {
                var i = this, j = this.options.templates, k = null, l = "", m = h(c.searchField),
                    n = a(j.search.resolve(f.call(this))), o = n.is(m) ? n : n.find(m);
    ...
    function C() {
        var b = this, c = this.element.find("thead > tr"), d = this.options.css,
            e = this.options.templates, g = "", i = this.options.sorting;
        if (this.selection) {
            var j = this.options.multiSelect ? e.select.resolve(f.call(b, {
                type: "checkbox",
                value: "all"
            })) : "";
            g += e.rawHeaderCell.resolve(f.call(b, {content: j, css: d.selectCell}))
        }
        if (a.each(this.columns, function (a, c) {
            if (c.visible) {
                var h = b.sortDictionary[c.id],
                    j = i && h && "asc" === h ? d.iconUp : i && h && "desc" === h ? d.iconDown : "",
                    k = e.icon.resolve(f.call(b, {iconCss: j})), l = c.headerAlign,
    ...
    function D(a) {
        var b = this.options.css, c = h(b.icon),
            d = a.data("column-id") || a.parents("th").first().data("column-id"),
            e = this.sortDictionary[d], f = a.find(c);
    ...
    function F() {
        ...
        b.setTimeout(function () {
            if ("true" === a.element._bgAria("busy")) {
                var b = a.options.templates, c = a.element.children("thead").first(),
                    d = a.element.children("tbody").first(), e = d.find("tr > td").first(),
                    g = a.element.height() - c.height() - (e.height() + 20),
                    h = a.columns.where(l).length;
                a.selection && (h += 1), d.html(b.loading.resolve(f.call(a, {columns: h}))), -1 !== a.rowCount && g > 0 && d.find("tr > td").css("padding", "20px 0 " + g + "px")
            }
        }, 250)
    }
    ...
    var H = ".rs.jquery.bootgrid", I = function (b, c) {
    ...
    if (I.defaults = {
        ...
        if (a = a || "", this.searchPhrase !== a) {
            var b = h(this.options.css.searchField), c = e.call(this, b);
            c.val(a)
        }
    ...
    a.fn.bootgrid = function (b) {
        var c = Array.prototype.slice.call(arguments, 1), d = null, e = this.each(function (e) {
            var f = a(this), g = f.data(H), h = "object" == typeof b && b;
            if ((g || "destroy" !== b) && (g || (f.data(H, g = new I(this, h)), j.call(g)), "string" == typeof b)) if (0 === b.indexOf("get") && 0 === e) d = g[b].apply(g, c); else if (0 !== b.indexOf("get")) return g[b].apply(g, c)
        });
